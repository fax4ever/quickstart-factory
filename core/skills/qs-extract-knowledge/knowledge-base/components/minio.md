---
name: minio
description: "S3-compatible object storage for attachments, models, RAG indexes, Langfuse, KServe, document/MLflow, video/config, observability, model-upload, and DSPA pipeline storage"
...
tags:
  ...
  platform: [openshift, rhoai, opendatahub, kserve, tempo, loki, dspa]
  data_layer: [minio]
source_examples:
  ...
  - quickstart: "product-recommender-system"
    ...
    notes: "In-repo Helm Deployment with post-install bucket Job, ODH labels, Makefile credential validation, DSPA pipeline server and minio Python SDK backend consumers via dynamic ds-pipeline-s3-dspa Secret"
    approach: "C"
