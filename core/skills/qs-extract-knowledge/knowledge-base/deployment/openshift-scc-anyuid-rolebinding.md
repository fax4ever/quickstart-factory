...
source_examples:
  ...
  - quickstart: "product-recommender-system"
    ...
    notes: "Anyuid SCC for pipeline-runner-dspa SA via RoleBinding in pipeline-server subchart for Kubeflow pipeline execution"
    approach: "A"
---
