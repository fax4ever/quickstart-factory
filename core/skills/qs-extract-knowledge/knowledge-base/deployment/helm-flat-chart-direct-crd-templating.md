...
source_examples:
  ...
  - quickstart: "portfolio-manager-agent"
    ...
    notes: "Flat chart with 23 template files for multi-agent system: shared image repo with per-service tags, optional Knative serverless toggle, NemoGuardrails CRD, KServe InferenceService with MLServer sklearn, MinIO model-upload Job, and per-service Route/Service templates"
    approach: "A"
---
