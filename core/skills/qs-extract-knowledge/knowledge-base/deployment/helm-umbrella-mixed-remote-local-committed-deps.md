...
source_examples:
  ...
  - quickstart: "spending-transaction-monitor"
    ...
    notes: "3 remote deps (llm-service, llama-stack, pgvector), 2 file:// local subcharts (keycloak, alert-recommender-pipeline) with condition toggles, nested subchart has its own remote dep (model-registry)"
    approach: "C"
---
